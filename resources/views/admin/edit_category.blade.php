...
<div class="">
    ...
    <div class="overflow-x-auto relative sm:rounded-lg">
        <div class="border border 1 border-black w-1/3 p-2 rounded">
            <form action="{{ route('update_category') }}" method="post">
                @method('PUT')
                @csrf
                <div class="flex flex-col py-2">
                    <span class="font-bold">Enter the new Category's name</span>
                ...
                <input type="submit" name="" id="" value="Save" class="mt-2 mb-4 font-semibold text-white-400 bg-gradient-to-r from-sky-300 via -indigo-300 
                    to-orange-200 p-2 rounded-md text-white hover:opacity-80 hover:border hover:text-gray-800">
            </form>
        </div>
        <table class="w-1/3 text-sm text-left text-gray-500 dark:text-gray-400 shadow-2xl my-10 mx-25">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <td class="py-4 px-6">
                        ...
                        <form action="{{ route('edit_category', ['id' => $cat['id']] ) }}" method="post">
                            @method('PUT')
                            @csrf
